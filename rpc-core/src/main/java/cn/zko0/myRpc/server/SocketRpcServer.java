...
//
//    public SocketRpcServer(ServiceProvider serviceProvider, RequestHandler requestHandler) {
...
//                threadPool.execute(new HandlerThread(socket, serviceProvider, requestHandler));
//            }
//        } catch (IOException e) {
